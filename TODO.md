...
> Maintain using the automation plan-first workflow: brainstorm with approved tooling, convert action items here before coding, check off via PRs.
...
- [x] Phase 1: Author initial `AUTOMATION_GUIDE.md` describing agent expectations and workflow rituals (AUTOMATION_AGENTS.md created).
- [x] Phase 2: Define specialized automation agents and prompt templates; documented in AUTOMATION_AGENTS.md (completed 2025-09-21).
