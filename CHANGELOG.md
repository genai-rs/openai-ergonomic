...
## [0.6.0](https://github.com/genai-rs/openai-ergonomic/compare/v0.5.2...v0.6.0) - 2026-09-24
...
- align Langfuse tracing with OpenTelemetry 0.32
...
- *(deps)* Update Rust crate opentelemetry_sdk to ^0.32.1 [SECURITY]
- *(deps)* Update Rust crate rand to ^0.10.3
...
- add Error::Tool and Error::Application variants for fallible dispatch and preserved domain errors; this is a breaking change for exhaustive Error matches and requires a minor release before 1.0
...
## [0.5.1](https://github.com/genai-rs/openai-ergonomic/compare/v0.5.0...v0.5.1) - 2025-11-17
...
- *(deps)* Update Rust crate bytes to ^1.11.0
- *(deps)* Update rust patch updates
- silence new clippy lint (genai-rs-XX)
- unblock client-base upgrade (genai-rs-XX)
- upgrade openai-client-base dependency
